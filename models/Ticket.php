<?php
    ...
    class Ticket extends Conectar{
        ...
        public function insert_ticket($usu_id, $cat_id, $tick_titulo, $tick_descrip, $prio_id){

            $conectar = parent::conexion();
            parent::set_names();
            $sql = "INSERT INTO tm_ticket (tick_id, usu_id, cat_id, tick_titulo, tick_descrip, tick_estado, fech_crea, usu_asig, fech_asig, prio_id, est) VALUES (NULL, ?, ?, ?, ?, 'Abierto', now(), null, null, ?, 1)";
        ...
        public function listar_ticket_x_usu($usu_id)
        {
            ...
            WHERE
            tm_ticket.est = 1 AND tm_usuario.usu_id = ?";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $usu_id);
            $sql->execute();
        ...
        public function insert_ticketdetalle($tick_id, $usu_id, $tickd_descrip){
            ...
            if ($_SESSION["rol_id"] == 1) {
                    ...
                    // TODO: Guardar notificación de nuevo comentario
                    $sql0 = "INSERT INTO tm_notificacion (not_id, usu_id, not_mensaje, tick_id, est) VALUES (null, $usu_asig, 'Tiene una nueva respuesta del usuario con Nº de ticket: ', $tick_id, 2)";
                    $sql0 = $conectar->prepare($sql0);
                    $sql0->execute();
                        
                // TODO: Rol es = 2 Soporte Insertar alerta para usuario que generó el ticket
            } else {
                    // TODO: Guardar notificación de nuevo comentario
                    $sql0 = "INSERT INTO tm_notificacion (not_id, usu_id, not_mensaje, tick_id, est) VALUES (null, $usu_crea, 'Tiene una nueva respuesta de soporte del ticket Nº: ', $tick_id, 2)";
                    $sql0 = $conectar->prepare($sql0);
                    $sql0->execute();
            }
        ...
        public function updateTicket($tick_id)
        {
            $conectar = parent::conexion();
            parent::set_names();
        ...
        public function update_ticket_asignacion($tick_id, $usu_asig)
        {
            ...
            $sql1 = "INSERT INTO tm_notificacion (not_id, usu_id, not_mensaje, tick_id, est) VALUES (null, ?, 'Se le ha asignado el ticket Nº: ', ?, 2)";
            $sql1 = $conectar->prepare($sql1);
        ...
        public function reabrirTicket($tick_id)
        {
            $conectar = parent::conexion();
            parent::set_names();
